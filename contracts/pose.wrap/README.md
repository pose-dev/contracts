...
Execute a transaction while bypassing regular authorization checks (requires authorization of pose.wrap which needs to be a privileged account).

### pose.wrap::exec    executer trx
...
## 2. Installing the pose.wrap contract
